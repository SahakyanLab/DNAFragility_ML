...
# extract features
Rscript 00_Process_SNP.R

for batch in {1..40}
do
   Rscript 01_Get_Features_SV.R $sub_batch
done
...
Rscript 02_Process_SV_predictions.R 

# analyse results
Rscript 02_analyse_predictions_SNPs.R

for bw in 1960 10000 20000
do
   Rscript 03_analyse_predictions_SVs.R $bw
done